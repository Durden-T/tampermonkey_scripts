...
const ThreadChangeDisplay = React.memo(
  ({ change, t }: { change: TitleChange; t: ReturnType<typeof getTexts> }) => (
...
ThreadChangeDisplay.displayName = 'ThreadChangeDisplay';

export const ThreadItem = React.memo<ThreadItemProps>(
  ({ thread, change, isBlacklisted, onOpen, onBlock, onResume }) => {
    const t = getTexts();
